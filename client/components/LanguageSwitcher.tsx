...
export function LanguageSwitcher({
  ...
  return (
    <div
      className={`flex items-center space-x-2 rounded-lg px-3 py-2 transition-all duration-300 ${baseStyles} ${className}`}
    >
      <Languages
        className={`h-4 w-4 transition-all duration-300 ${iconStyles} ${
      ...
      <div className="relative">
        ...
        {isChanging && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div
              className={`h-3 w-3 animate-spin border rounded-full ${
                variant === "chatbot"
